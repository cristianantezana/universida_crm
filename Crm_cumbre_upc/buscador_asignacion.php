...
$sql = ("SELECT id_contacto, nombre,apellido,descripcion 
FROM contactos  WHERE nombre LIKE LOWER('%" . $_POST['buscar'] . "%')
OR apellido LIKE LOWER ('%" . $_POST['buscar'] . "%') ORDER BY id_contacto DESC LIMIT 10;");
        ...
        while ($dataRegistro = mysqli_fetch_assoc($result)) { ?>
            <tr id="id<?php echo $dataRegistro['id_contacto']; ?>">
                <td class="text-center">
                    ...
                    value="<?php echo $dataRegistro['id_contacto']; ?>" 
