<?php
	...
	$sql = "SELECT c.id_contacto, c.nombre, c.apellido, 
	c.parentesco, c.colegio_instituto, c.telefono, 
	c.turno_llamada,c.tipo_colegio, c.carrera_secundaria,c.telefono_padre,c.tipo,
	c.descripcion, ca.carrera, i.instancia, o.datos FROM contactos c 
	...
	INNER JOIN origen_dato o ON c.origen_contacto = o.id_dato  WHERE nombre 
	LIKE LOWER('%" . $_POST['buscar'] . "%') 
	OR apellido LIKE LOWER('%" . $_POST['buscar'] . "%') ORDER BY c.id_contacto DESC LIMIT 10;";
